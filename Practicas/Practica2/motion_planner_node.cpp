...
#include "../state_machines/bug_1.h"
#include "../state_machines/bug_2.h"
		...
		if((cta_steps)==0)
		  {
		   ...
		   regreso=0;
                   m=(params.light_y-params.robot_y)/(params.light_x-params.robot_x);
		   x0=params.robot_x;
		   y0=params.robot_y;
		  }

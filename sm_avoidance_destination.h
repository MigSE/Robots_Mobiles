...
#define THRESHOLD 35
#define LIDAR_THRESHOLD 0.25

// State Machine 
int sm_avoidance_destination(float *observations,int size,float intensity, int  dest,int obs ,movement *movements  ,int *next_state ,float Mag_Advance ,float max_twist)
{
